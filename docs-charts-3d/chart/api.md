...
<ApiTable title="Options 通用字段" :rows="[
  ...
  { name: 'camera', desc: '轨道相机：{ yaw, pitch, distance, fov, target, minPitch, maxPitch, minDistance, maxDistance, autoRotate, autoRotateSpeed, damping }，详见[相机与交互](/guide/camera)', type: 'object', default: '—' },
  ...
  { name: 'palette', desc: '内置色系一键固定（classic / aurora / sunset / morandi / forest / ink / candy），与 Evoke Charts 同 id 同色值；生效后不读系列色令牌。详见[主题接入](/guide/theme)', type: 'string', default: '—' },
