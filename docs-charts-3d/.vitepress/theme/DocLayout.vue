    ...
    <header class="cd-header">
      <div class="cd-header__inner">
        <a class="cd-logo" href="/" @click.prevent="go('/')">
          <span class="cd-logo__name">Charts 3D</span>
        ...
        <div class="cd-header__right">
          ...
          <a
            ...
            href="https://www.npmjs.com/package/@wil-works/charts-3d"
            target="_blank"
            rel="noopener"
            aria-label="下载"
            title="npm 下载"
...
import { BRAND, GUIDE_NAV, CHART_NAV, ALL_CHART_PAGES, ALL_GUIDE_PAGES } from './meta.js'
...
const navItems = computed(() => [
  ...
  { key: 'charts', label: '图型', icon: 'chart', path: '/chart', active: isChart.value },
  {
    key: 'family',
    label: '官方库',
    icon: 'globe',
    children: [
      ...
      { label: '二维图表库 · Evoke Charts', path: 'https://evoke-charts.wil-works.com' },
    ],
  },
])
...
const results = computed(() => {
  ...
  if (!q) return []
  const pool = [...ALL_CHART_PAGES, ...ALL_GUIDE_PAGES]
  return pool.filter(
