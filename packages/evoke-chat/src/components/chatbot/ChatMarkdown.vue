...
// 代码块工具条的两条文案是烘进 HTML 的：切语言要连带重渲染
watch(() => [props.content, props.streaming, labels.markdown.copyCode, labels.markdown.renderDiagram], schedule, { immediate: true });
