...
export interface UseScrollProgressOptions {
  /** sticky 吸附偏移 px，可为响应式函数 */
  offset?: number | string | (() => number | string)
}

export function useScrollProgress(
  target: Ref<HTMLElement | null | undefined>,
  { offset = 0 }: UseScrollProgressOptions = {},
): { progress: Ref<number>; reduced: Ref<boolean> } {
  ...
  function resolveOffset(v: number | string | (() => number | string)): number {
