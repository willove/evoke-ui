...
/**
 * @param {import('vue').Ref<HTMLElement|null>} containerRef 圈禁容器
 * @param {Object} [options]
 * @param {boolean} [options.escapeDeactivates=true] ESC 是否退出
 * @param {(e: KeyboardEvent) => void} [options.onEscape] ESC 回调
 * @param {boolean} [options.initialFocus=true] 激活时聚焦容器
