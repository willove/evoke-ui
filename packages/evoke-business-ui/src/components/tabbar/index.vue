<template>
  <div>
    ...
    <div v-if="fixed && placeholder" class="eb-tabbar__placeholder" :style="{ height: `${barHeight}px` }" />
    <div :class="['eb-tabbar', { 'is-fixed': fixed, 'is-border': border, 'is-safe': safeAreaInsetBottom }]">
      <slot />
    </div>
  </div>
</template>
