...
const props = defineProps({
  ...
  // 默认跟随主题 warning 令牌（明暗自适应）；要还原经典琥珀色可传 ['#F7BA2A','#F7BA2A','#F7BA2A']
  colors: { type: [Array, Object], default: () => ['var(--eb-color-warning, #F7BA2A)', 'var(--eb-color-warning, #F7BA2A)', 'var(--eb-color-warning, #F7BA2A)'] },
  voidColor: { type: String, default: 'var(--eb-fill-color-darker, #C6D1DE)' },
  disabledColor: { type: String, default: 'var(--eb-text-color-disabled, #C9CDD4)' },
  ...
  textColor: { type: String, default: 'var(--eb-text-color-primary, #1F2D3D)' },
