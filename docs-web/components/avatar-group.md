...
`EwAvatarGroup` 将多个头像层叠排布，用于团队成员、协作者与参与用户等群体展示。
...
<div style="display:flex; align-items:center; gap:12px;">
  <EwAvatarGroup
    ...
    :max="4"
  />
  <span style="font-size:13px; color:var(--ew-text-secondary);">已有 <b style="color:var(--ew-text-primary)">12,800+</b> 位创作者加入</span>
</div>
