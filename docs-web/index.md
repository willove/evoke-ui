...
<EvNavbar class="home-navbar" logo-text="Evoke UI" :items="[
  ...
  <template #logo>
    <a href="/" class="home-brand">
      ...
      <EvTag size="small">v0.10.1</EvTag>
    </a>
  </template>
  <template #actions>
...
>
  <template #badge>
    <EvAlert pill>
      <span>v0.10.1 发布：EvSection width 定宽档——narrow / default / wide 超宽居中不撑边；与 Container 同令牌整站可调</span>
      <template #action>
  ...
  <template #aside>
    <div class="home-collage">
      ...
      <div class="home-collage__chip">
        <EvTag tone="primary" size="small">v0.10.1</EvTag>
...
<div class="home-stats-band">
  <div class="ev-container home-stats">
    <EvStatistic value="60" label="组件" align="center" animated />
