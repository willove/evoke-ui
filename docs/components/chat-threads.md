...
<DemoBlock>
  <div style="height: 300px; border: 1px solid var(--eb-border-color-light); border-radius: 8px; overflow: hidden;">
    <eb-chat-threads
...
<script setup>
import { ref } from 'vue'
import { useChatSessions } from '@wil-works/evoke-business-ui'
