...
节点内容写在 `eb-timeline-item` 默认插槽，`timestamp` 显示时间戳（默认在内容下方），`type` 设置语义色圆点。

<DemoBlock>
  <eb-timeline>
    <eb-timeline-item timestamp="2026-08-01 09:00" type="primary">创建订单</eb-timeline-item>
    <eb-timeline-item timestamp="2026-08-01 10:30" type="success">支付完成</eb-timeline-item>
    <eb-timeline-item timestamp="2026-08-01 12:00" type="warning">等待发货</eb-timeline-item>
    <eb-timeline-item timestamp="2026-08-02 08:00" type="info">订单关闭</eb-timeline-item>
  </eb-timeline>
</DemoBlock>
...
<DemoBlock>
  <eb-timeline mode="alternate" variant="filled">
    <eb-timeline-item label="08-01" timestamp="09:00" type="primary">需求评审通过</eb-timeline-item>
    <eb-timeline-item label="08-02" timestamp="14:00" type="success">开发联调完成</eb-timeline-item>
    <eb-timeline-item label="08-03" timestamp="10:00" type="danger">修复线上缺陷</eb-timeline-item>
  </eb-timeline>
</DemoBlock>
...
<DemoBlock>
  <eb-timeline style="padding-left: 110px; padding-right: 110px;">
    <eb-timeline-item timestamp="2026-08-01 09:00" placement="top">时间戳在内容上方</eb-timeline-item>
    <eb-timeline-item timestamp="2026-08-01 10:30">默认在内容下方</eb-timeline-item>
    <eb-timeline-item timestamp="09:45" placement="start">时间戳移到轴左侧</eb-timeline-item>
    <eb-timeline-item timestamp="10:45" placement="end">时间戳移到轴右侧</eb-timeline-item>
  </eb-timeline>
</DemoBlock>
...
<DemoBlock>
  <eb-timeline variant="filled">
    <eb-timeline-item color="#722ed1">任意色值</eb-timeline-item>
    <eb-timeline-item color="green">语义色名映射主题 token</eb-timeline-item>
    <eb-timeline-item hollow>空心圆点</eb-timeline-item>
  </eb-timeline>
</DemoBlock>
...
<DemoBlock>
  <eb-timeline>
    <eb-timeline-item type="success" icon="check" size="large">图标圆点（large 尺寸）</eb-timeline-item>
    <eb-timeline-item type="danger" icon="close">图标圆点</eb-timeline-item>
    <eb-timeline-item type="warning">
      <template #dot>
        <span style="display: block; width: 10px; height: 10px; border-radius: 50%; background: var(--eb-color-warning);"></span>
      </template>
      完全自定义圆点
    </eb-timeline-item>
  </eb-timeline>
...
<DemoBlock>
  <eb-timeline pending="加载历史记录中">
    <eb-timeline-item timestamp="2026-08-01 09:00">创建订单</eb-timeline-item>
    <eb-timeline-item timestamp="2026-08-01 10:30">支付完成</eb-timeline-item>
  </eb-timeline>
</DemoBlock>
...
<DemoBlock>
  <eb-timeline reverse pending="同步最新动态中">
    <eb-timeline-item timestamp="2026-08-01 09:00">创建订单</eb-timeline-item>
    <eb-timeline-item timestamp="2026-08-01 10:30">支付完成</eb-timeline-item>
  </eb-timeline>
</DemoBlock>
...
<ApiTable title="Timeline Slots" :rows="[
  { name: 'default', desc: 'eb-timeline-item 节点列表', type: '—', default: '—' },
]" />
